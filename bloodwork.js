...
window.BLOODWORK =
{
 ...
 "STACK": {
  ...
  "items": [
   {"id": "astax", "name": "Astaxanthin", "dose": "12mg 2x/day", "info": "Strong skin-photoprotection evidence — raises the UV-burn threshold, plus moisture and elasticity. Not skin colour, though: that's beta-carotene's job, not this one's. 24mg/day, split 12mg twice with fat. Sits above the EU daily cap (16mg at your weight) but is safe to 40mg — held here until there's proof it does anything for colour.", "cat": "skin", "status": "taking", "when": null, "url": null, "dec": null},
   {"id": "lyco", "name": "Lycopene", "dose": "15mg 2x/day", "info": "Adds a warm skin tone and gives real UV photoprotection at 10-16mg. Blood levels saturate by ~30-40mg, so the old 50mg was mostly wasted — 30mg (15mg twice with fat) captures the benefit and stays under the EU cap. Tomato-derived (LycoBeads) beats synthetic, and cooked tomato in olive oil beats raw.", "cat": "skin", "status": "taking", "when": null, "url": "https://www.sunday.de/en/lycopene-capsules.html", "dec": null},
   {"id": "vitd3k2", "name": "Vitamin D3 + K2", "dose": "5000 IU", "info": "Repletes vitamin D; the K2 MK-7 steers the extra calcium into bone rather than arteries. Take 5000 IU/day, but titrate it to your blood 25-OH-D (aim 40-60 ng/mL) instead of holding blind. Already on it, so it'll show up in the baseline draw.", "cat": "essentials", "status": "taking", "when": null, "url": "https://www.sunday.de/en/vitamin-d-tablets-5000-iu-plus-k2-mk7-100mcg-xl.html", "dec": "Vitamin D3 5000 IU + K2"},
   {"id": "iodine", "name": "Iodine", "dose": "300mcg", "info": "Thyroid support at 300mcg — but only worth taking if you're genuinely low. Waiting on a thyroid panel (TSH, anti-TPO) and your dietary intake; Huel, dairy and eggs may already cover you, and too much iodine can tip the thyroid either way.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "Iodine 300mcg"},
   {"id": "omega3", "name": "Omega-3", "dose": "800mg EPA + 450mg DHA", "info": "EPA/DHA at a general-health dose. Algae oil in triglyceride form — cleaner than fish oil (no heavy metals, low oxidation) and iodine-free. 2 softgels/day give 800mg EPA + 450mg DHA; titrate to your omega-3 index (aim 8-12%), going to 3/day only if it reads low.", "cat": "essentials", "status": "planned", "when": null, "url": "https://www.sunday.de/en/omega-3-epa-dha-capsules.html", "dec": "Omega-3 (800mg EPA, 450mg DHA)"},
   {"id": "collagenc", "name": "Collagen peptides (low-MW)", "dose": "2g", "info": "Low-weight peptides (~500 Da, mostly tripeptides) that signal your skin to build its own collagen — it's the trigger, not the raw material, which your glycine already covers. 2g with vitamin C. Cosmetic, with modest evidence.", "cat": "skin", "status": "planned", "when": null, "url": "https://www.sunday.de/en/collagen-powder-sunglow-luxe-plus-c.html", "dec": "Glycine 12g + taurine + collagen"},
   {"id": "ha", "name": "Hyaluronic acid", "dose": "250mg", "info": "Doesn't reach the skin intact — only ~0.2% absorbs, and gut bacteria break it into fragments that signal the skin to make its own. A 2025 review of 7 trials shows modest hydration, elasticity and wrinkle gains. 250mg medium-weight HA, the dose those trials used. Cosmetic, and dependent on your gut flora.", "cat": "skin", "status": "planned", "when": null, "url": "https://www.sunday.de/en/hyaluronic-acid-250mg-high-dose-vegan-from-fermentation.html", "dec": null},
   {"id": "mglthr", "name": "Magnesium L-threonate", "dose": "2040mg", "info": "The magnesium form that crosses into the brain (Magtein®, 147mg elemental), marketed for sleep. But the sleep case is thin: you're young and already magnesium-replete (diet ~2× RDA), and this form's only trials are on cognition in older adults. A brain bet, not repletion — parked pending your own on/off sleep test.", "cat": "maylater", "status": "planned", "when": "evening", "url": "https://www.sunday.fr/magnesium-l-threonate-gelules.html", "dec": "Magnesium L-threonate"},
   {"id": "betacar", "name": "Beta-carotene", "dose": "15mg", "info": "The carotenoid that actually drives golden skin tone — the job astaxanthin can't do. Parked so you can judge astaxanthin + lycopene on their own first, then add this if the tint's still missing. Natural algae source (Dunaliella) — more bioactive and safer than synthetic, which raised lung-cancer risk only in smokers. 15mg with fat; push higher for more colour, but watch for orange palms.", "cat": "maylater", "status": "planned", "when": null, "url": "https://www.sunday.de/en/beta-carotene-algae-extract-capsules.html", "dec": null},
   {"id": "minoxidil", "name": "Minoxidil (topical)", "dose": "5-10%, 1mL 2x/day", "info": "Topical vasodilator for hair regrowth — barely absorbed (~1.4%) and non-hormonal, so nothing in bloodwork tracks it. Planned, not yet started.", "cat": "hair", "status": "planned", "when": null, "url": null, "dec": null},
   {"id": "finasteride", "name": "Finasteride (topical)", "dose": "0.1%, 1mL 2x/day", "cat": "hair", "status": "planned", "when": null, "url": null, "dec": "Finasteride (topical) 0.1% - 1mL",
    "info": "Blocks DHT, the hormone driving the hair loss — the effective core of the protocol. A topical 0.1% serum keeps systemic exposure low, but it's still finasteride: watch libido, erections and mood (depression included) over the first 6 months."},
   {"id": "glycine", "name": "Glycine", "dose": "12g", "info": "12g is a high dose with no pinned reason yet — sleep aid, GlyNAC glutathione booster, or collagen raw material? Decide it together with NAC and an actual glutathione goal.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "Glycine 12g + taurine + collagen"},
   {"id": "nac", "name": "NAC", "dose": "2000mg", "info": "A glutathione and antioxidant precursor, but the goal isn't set — and at 2g it's unbalanced against the 12g glycine if GlyNAC is the aim. Revisit once oxidative or glutathione markers give it a target.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "NAC 2000mg"},
   {"id": "tmg", "name": "TMG", "dose": "1000mg", "info": "Lowers homocysteine by donating a methyl group, so homocysteine is the number that justifies it. Waiting on that draw — and on your B-vitamin status, which does the same job.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "TMG 1000mg"},
   {"id": "garlic", "name": "AGE garlic", "dose": "2400mg", "info": "Aged garlic's evidence is cardiovascular — modest effects on blood pressure and lipids, real mainly when those are already elevated. Parked until your lipid panel or BP gives it a job.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "AGE garlic 2400mg"},
   {"id": "curcumin", "name": "Curcumin", "dose": null, "info": "Anti-inflammatory, but no dose is set and it's barely absorbed without piperine or a special formulation. Parked until an inflammatory marker like hs-CRP is high enough to actually target.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "Curcumin"},
   {"id": "creatine", "name": "Creatine", "dose": "5g", "info": "The most-proven supplement in the stack — strength, power, and likely cognition. 5g/day baseline (in the Huel), up to 20g on poor-sleep weeks (+5g brunch, +10g dinner). It works by saturating the muscle, so exact timing doesn't matter.", "cat": "sport", "status": "planned", "when": null, "url": "https://amzn.eu/d/09MG0JOC", "dec": "Creatine 5g"},
   {"id": "taurine", "name": "Taurine", "dose": "5g", "info": "The longevity buzz is real but the evidence is mouse and observational, not human trials. Cheap and low-risk, but unproven — parked until there's human data or a specific reason to run it.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "Glycine 12g + taurine + collagen"},
   {"id": "boron", "name": "Boron", "dose": "5mg", "info": "Small studies suggest it nudges free testosterone up by lowering SHBG. Modest, and unclear at your age — parked until testosterone/SHBG bloods suggest it's worth it.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "Boron 5mg"},
   {"id": "tretinoin", "name": "Tretinoin / retinoic acid (topical)", "dose": "0.01%, 1mL", "info": "An add-on that makes minoxidil work harder — it increases how much the follicles absorb. A candidate for the hair protocol, not committed yet.", "cat": "hairlater", "status": "candidate", "when": null, "url": null, "dec": null},
   {"id": "ketoconazole", "name": "Ketoconazole (topical)", "dose": "2%, 1mL 3x/week", "info": "Nizoral shampoo, used off-label for hair — it lowers DHT at the scalp and calms inflammation. A modest add-on to the hair protocol, not committed yet.", "cat": "hairlater", "status": "candidate", "when": null, "url": null, "dec": null}
  ]
 },
 "ROUTINE": [
