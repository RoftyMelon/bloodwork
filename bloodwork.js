...
window.BLOODWORK =
{
 ...
 "STACK": {
  ...
  "items": [
   ...
   {"id": "lyco", "name": "Lycopene", "dose": "15mg 2x/day", "info": "Warm skin tone plus UV photoprotection (10-16mg). Absorption saturates by ~30-40mg, so 30mg (15mg twice with fat) is the ceiling — more just gets excreted. Tomato-derived (LycoBeads) beats synthetic; cooked tomato in olive oil beats raw.", "cat": "skin", "status": "taking", "when": null, "url": "https://www.sunday.de/en/lycopene-capsules.html", "dec": null},
   {"id": "vitd3k2", "name": "Vitamin D3 + K2", "dose": "5000 IU", "info": "Vitamin D repletion; the K2 steers calcium into bone, not arteries. 5000 IU/day, but titrate to blood 25-OH-D (40-60 ng/mL), not on autopilot. Already taking — shows in the baseline draw.", "cat": "essentials", "status": "taking", "when": null, "url": "https://www.sunday.de/en/vitamin-d-tablets-5000-iu-plus-k2-mk7-100mcg-xl.html", "dec": "Vitamin D3 5000 IU + K2"},
   {"id": "iodine", "name": "Iodine", "dose": "300mcg", "info": "Thyroid, 300mcg — but only if you're genuinely low. Pending a thyroid panel (TSH, anti-TPO); Huel, dairy and eggs may already cover you, and excess can tip the thyroid either way.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "Iodine 300mcg"},
   {"id": "omega3", "name": "Omega-3", "dose": "800mg EPA + 450mg DHA", "info": "EPA/DHA, general-health dose. Algae oil (triglyceride form) — cleaner than fish oil, iodine-free. 2 softgels/day = 800mg EPA + 450mg DHA; titrate to your omega-3 index (8-12%), 3/day if low.", "cat": "essentials", "status": "planned", "when": null, "url": "https://www.sunday.de/en/omega-3-epa-dha-capsules.html", "dec": "Omega-3 (800mg EPA, 450mg DHA)"},
   {"id": "collagenc", "name": "Collagen peptides (low-MW)", "dose": "2g", "info": "Low-weight peptides (~500 Da) that signal skin to build its own collagen — the trigger, not the raw material (glycine covers that). 2g with vitamin C. Cosmetic, modest evidence.", "cat": "skin", "status": "planned", "when": null, "url": "https://www.sunday.de/en/collagen-powder-sunglow-luxe-plus-c.html", "dec": "Glycine 12g + taurine + collagen"},
   {"id": "ha", "name": "Hyaluronic acid", "dose": "250mg", "info": "Not absorbed intact (~0.2%) — gut bacteria fragment it into signals for the skin's own HA. 2025 review (7 trials): modest hydration, elasticity and wrinkle gains. 250mg, the trial dose. Cosmetic, gut-flora-dependent.", "cat": "skin", "status": "planned", "when": null, "url": "https://www.sunday.de/en/hyaluronic-acid-250mg-high-dose-vegan-from-fermentation.html", "dec": null},
   {"id": "mglthr", "name": "Magnesium L-threonate", "dose": "2040mg", "info": "Brain-penetrant magnesium (147mg elemental), sold for sleep. But the sleep case is thin — you're young and replete (~2× RDA), and its only trials are cognition in older adults. Parked pending your own on/off sleep test.", "cat": "maylater", "status": "planned", "when": "evening", "url": "https://www.sunday.fr/magnesium-l-threonate-gelules.html", "dec": "Magnesium L-threonate"},
   ...
   {"id": "glycine", "name": "Glycine", "dose": "12g", "info": "12g, but no pinned reason — sleep, GlyNAC glutathione, or collagen substrate? Decide with NAC and a real glutathione goal.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "Glycine 12g + taurine + collagen"},
   {"id": "nac", "name": "NAC", "dose": "2000mg", "info": "Glutathione precursor, but no set goal — and at 2g it's unbalanced against the 12g glycine for GlyNAC. Revisit with oxidative/glutathione markers.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "NAC 2000mg"},
   {"id": "tmg", "name": "TMG", "dose": "1000mg", "info": "Lowers homocysteine (methyl donor) — so homocysteine is the number that justifies it. Pending that draw and your B-vitamin status, which does the same job.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "TMG 1000mg"},
   {"id": "garlic", "name": "AGE garlic", "dose": "2400mg", "info": "Cardiovascular — modest BP and lipid effects, real mainly if those are already high. Parked until your lipid panel or BP gives it a job.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "AGE garlic 2400mg"},
   {"id": "curcumin", "name": "Curcumin", "dose": null, "info": "Anti-inflammatory, but no dose set and barely absorbed without piperine. Parked until an inflammatory marker (hs-CRP) is high enough to target.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "Curcumin"},
   ...
   {"id": "taurine", "name": "Taurine", "dose": "5g", "info": "The longevity buzz is real, but the evidence is mouse and observational, not human. Cheap and low-risk but unproven — parked until human data or a specific reason.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "Glycine 12g + taurine + collagen"},
   {"id": "boron", "name": "Boron", "dose": "5mg", "info": "May nudge free testosterone up by lowering SHBG — modest, and unclear at your age. Parked until testosterone/SHBG bloods suggest a reason.", "cat": "maylater", "status": "planned", "when": null, "url": null, "dec": "Boron 5mg"},
